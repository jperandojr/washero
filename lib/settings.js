...
// yet, Supabase is unreachable/misconfigured, or the row doesn't exist for
// any other reason, so the public site (and the build itself) never breaks
// while settings are being configured.
